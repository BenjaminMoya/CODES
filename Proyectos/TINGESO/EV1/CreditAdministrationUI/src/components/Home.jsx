const Home = () => {
  return (
    <div>
      <h1>Banco Usachin: Sistema de gestion de prestamos y creditos hipotecarios</h1>
      <p>
        Banco Usachin es una aplicación web para solicitar y gestionar prestamos y creditos hipotecarios.
